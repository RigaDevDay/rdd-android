...
class VenueFragment : BaseFragment() {
    ...
    companion object {
        fun newInstance(index: Int) = VenueFragment().apply {
    ...
    override fun viewReady(view: View) {
        ...
        dataFetchSubscription = repo.venue(index).subscribe({ venue -> poplateView(view, venue) })
    }

    fun poplateView(view: View, venue: Venue) = with(view) {
